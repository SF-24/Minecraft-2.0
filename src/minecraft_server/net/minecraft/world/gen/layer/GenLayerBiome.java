    ...
    public GenLayerBiome(long varLong, GenLayer genLayer, WorldType worldType, String varString)
    {
        ...
        else if (worldType == WorldType.RANDOM_BIOMES)
        {
            this.randomBiomeList = new BiomeGenBase[]
            {
                ...
                BiomeGenBase.jungle,BiomeGenBase.jungle, BiomeGenBase.tropical_swampland,
                ...
                BiomeGenBase.forest, BiomeGenBase.taiga, BiomeGenBase.megaTaiga,
                BiomeGenBase.iceMountains, BiomeGenBase.icePlains, BiomeGenBase.icePlains, BiomeGenBase.icePlains, BiomeGenBase.coldTaiga
            };
